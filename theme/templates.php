  ...
  <header>
        <div class="topbar navbar-fixed-top">
          <div class="container">
            <div class="row">
              <div class="col-md-12">      
                <p class="pull-left hidden-xs"><i class="fa fa-phone"></i>Tel No. (+632) 8 859 0888</p>
        ...
        <div class="navbar navbar-default navbar-static-top" > 
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="<?php echo web_root; ?>index.php">PATHS<!-- <img src="<?php echo web_root; ?>plugins/home-plugins/img/logo.png" alt="logo"/> --></a>
                </div>
    ...
    <div class="row">
      <div class="col-md-4 col-sm-4">
        <div class="widget">
          ...
          667 United Nations Avenue Ermita<br>
           1000 Manila Metro Manila </address>
          <p>
            <i class="icon-phone"></i> (+632) 8 859 0888 <br>
            <i class="icon-envelope-alt"></i> atolentino_07@mtc.edu.ph
          </p>
        </div>
      </div>
      <div class="col-md-4 col-sm-4">
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6">
          <div class="copyright">
            <p>
              <span>&copy; MTCPATHS 2023 All right reserved.  
            </p>
          </div>
        </div>
        <div class="col-lg-6">
